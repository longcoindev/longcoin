...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 LNG
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 LNG mininput
...
extern CLongSendPool longSendPool;
extern CLongSendSigner longSendSigner;
extern std::vector<CMasterNode> longSendMasterNodes;
extern std::vector<CMasterNodeVote> longSendMasterNodeVotes;
...
/** Used to keep track of current status of longsend pool
 */
class CLongSendPool
{
public:
