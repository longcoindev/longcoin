...
// Longcoin message start (switch from Litecoin's)
static unsigned char pchMessageStartLitecoin[4] = { 0xfb, 0xc0, 0xb6, 0xdb };
static unsigned char pchMessageStartLongcoin[4] = { 0xfb, 0xc0, 0xb6, 0xdb };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartLongcoin : pchMessageStartLitecoin, sizeof(pchMessageStartLongcoin));
}
