...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9035 or testnet: 19035)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9034 or testnet: 19034)") + "\n" +
        ...
        "\n" + _("SSL options: (see the LongCoin Wiki for SSL setup instructions)") + "\n" +
