...
static const char *strMainNetDNSSeed[][2] = {
    {"longcoin.org", "dnsseed.longcoin.org"},
    {"longcoin.qa", "dnsseed.longcoin.qa"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"longcoin.org", "testnet-seed.longcoin.org"},
    {"longcoin.qa", "testnet-seed.longcoin.qa"},
    {NULL, NULL}
};
...
void RelayLongSendElectionEntry(const CTxIn vin, const CService addr, const std::vector<unsigned char> vchSig, const int64 nNow, const CPubKey pubkey, const CPubKey pubkey2, const int count, const int current, const int64 lastUpdated)
{
    LOCK(cs_vNodes);
    BOOST_FOREACH(CNode* pnode, vNodes)
    {
...
void RelayLongSendElectionEntryPing(const CTxIn vin, const std::vector<unsigned char> vchSig, const int64 nNow, const bool stop)
{
    LOCK(cs_vNodes);
    BOOST_FOREACH(CNode* pnode, vNodes)
    {
